...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-node-red/node_modules/node-red/red/api/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-node-red/node_modules/node-red/red/api/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">79.63% <small>(86 / 108)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">79.63% <small>(86 / 108)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-node-red/node_modules/node-red/red/api/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
        // Editor
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!settings.disableEditor) {
            ui.init(runtime);
            var editorApp = express();
            <span class="missing-if-branch" title="if path not taken" >I</span>if (settings.requireHttps === true) {
...
<span class="cstat-no" title="statement not covered" >                        res.redirect('https://' + req.headers.host + req.originalUrl);</span>
            ...
            theme.init(runtime);
            <span class="missing-if-branch" title="if path not taken" >I</span>if (settings.editorTheme) {
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (settings.adminAuth) {
...
<span class="cstat-no" title="statement not covered" >            adminApp.post("/auth/revoke",needsPermission(""),auth.revoke,errorHandler);</span>
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (settings.httpAdminCors) {
