...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-node-red/node_modules/node-red/red/runtime/nodes/credentials.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-node-red/node_modules/node-red/red/runtime/nodes/credentials.js</span></h1>
    <h2>
        
        Statements: <span class="metric">29.68% <small>(46 / 155)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">29.68% <small>(46 / 155)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-node-red/node_modules/node-red/red/runtime/nodes/</a> &#187; credentials.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    load: function (credentials) {
        ...
        */
        var credentialsEncrypted = credentials.hasOwnProperty("$") &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >Object.keys(credentials).length === 1;</span>
        var setupEncryptionPromise = when.resolve();
        <span class="missing-if-branch" title="else path not taken" >E</span>if (encryptionEnabled === null) {
            var defaultKey;
            try {
                defaultKey = settings.get('_credentialSecret');
            } catch(err) {
            }
            <span class="missing-if-branch" title="else path not taken" >E</span>if (defaultKey) {
...
<span class="cstat-no" title="statement not covered" >                userKey = false;</span>
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (userKey === false) {
...
<span class="cstat-no" title="statement not covered" >                    removeDefaultKey = true;</span>
            ...
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof userKey === 'string') {
...
<span class="cstat-no" title="statement not covered" >                    removeDefaultKey = true;</span>
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (encryptionKey === undefined) {
...
<span class="cstat-no" title="statement not covered" >                    dirty = true;</span>
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (encryptionEnabled &amp;&amp; !dirty) {
            encryptedCredentials = credentials;
        }
        return setupEncryptionPromise.then(function() {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (credentials.hasOwnProperty("$")) {
