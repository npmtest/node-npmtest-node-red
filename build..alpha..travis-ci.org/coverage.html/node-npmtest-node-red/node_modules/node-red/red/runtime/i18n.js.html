...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-node-red/node_modules/node-red/red/runtime/i18n.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-node-red/node_modules/node-red/red/runtime/i18n.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-node-red/node_modules/node-red/red/runtime/</a> &#187; i18n.js</div>
</div>
<div class="body">
...
var MessageFileLoader = {
    fetchOne: function(lng, ns, callback) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (resourceMap[ns]) {
            ...
            fs.readFile(file,"utf8",function(err,content) {
                if (err) {
                    ...
                    try {
                        ...
                        <span class="missing-if-branch" title="if path not taken" >I</span>if (lng !== defaultLang) {
