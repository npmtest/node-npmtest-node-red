...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-node-red/node_modules/node-red/red/runtime/nodes/flows/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-node-red/node_modules/node-red/red/runtime/nodes/flows/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">26.63% <small>(94 / 353)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">8.37% <small>(18 / 215)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">19.61% <small>(10 / 51)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">26.63% <small>(94 / 353)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-node-red/node_modules/node-red/red/runtime/nodes/flows/</a> &#187; index.js</div>
</div>
<div class="body">
...
function init(runtime) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (started) {
<span class="cstat-no" title="statement not covered" >        throw new Error("Cannot init without a stop");</span>
    }
    settings = runtime.settings;
    storage = runtime.storage;
    started = false;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!typeEventRegistered) {
        events.on('type-registered',function(type) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (activeFlowConfig &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >activeFlowConfig.missingTypes.length &gt; 0)</span> {
...
function setFlows(_config,type,muteLog) {
    type = type||<span class="branch-1 cbranch-no" title="branch not covered" >"full";</span>
&nbsp;
    ...
    var newFlowConfig;
    var isLoad = false;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (type === "load") {
        isLoad = true;
...
&nbsp;
    return configSavePromise
        .then(function(flowRevision) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!isLoad) {
...
function start(type,diff,muteLog) {
    ...
    started = true;
    var i;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (activeFlowConfig.missingTypes.length &gt; 0) {
...
<span class="cstat-no" title="statement not covered" >        return when.resolve();</span>
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!muteLog) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (diff) {
<span class="cstat-no" title="statement not covered" >            log.info(log._("nodes.flows.starting-modified-"+type));</span>
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!diff) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!activeFlows['global']) {
...
&nbsp;
    for (id in activeFlows) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (activeFlows.hasOwnProperty(id)) {
            activeFlows[id].start(diff);
            var activeNodes = activeFlows[id].getActiveNodes();
            Object.keys(activeNodes).forEach(<span class="fstat-no" title="function not covered" >function(nid) {</span>
