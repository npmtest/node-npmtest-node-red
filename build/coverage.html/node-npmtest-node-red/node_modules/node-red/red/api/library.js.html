...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-node-red/node_modules/node-red/red/api/library.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-node-red/node_modules/node-red/red/api/library.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-node-red/node_modules/node-red/red/api/</a> &#187; library.js</div>
</div>
<div class="body">
...
function createLibrary(type) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (redApp) {
        redApp.get(new RegExp("/library/"+type+"($|\/(.*))"),needsPermission("library.read"),<span class="fstat-no" title="function not covered" >function(req,res) {</span>
...
&nbsp;
        redApp.post(new RegExp("/library/"+type+"\/(.*)"),needsPermission("library.write"),<span class="fstat-no" title="function not covered" >function(req,res) {</span>
