...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-node-red/node_modules/node-red/red/runtime/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-node-red/node_modules/node-red/red/runtime/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">66.67% <small>(64 / 96)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">65.96% <small>(62 / 94)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-node-red/node_modules/node-red/red/runtime/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
    nodeApp = express();
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (_adminApi) {
        adminApi = _adminApi;
    }
...
function start() {
    return i18n.init()
        ...
        .then(function() {
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (log.metric()) {
...
<span class="cstat-no" title="statement not covered" >                    reportMetrics();</span>
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (settings.version) {
                log.info(log._("runtime.version",{component:"Node-RED",version:"v"+settings.version}));
            }
            log.info(log._("runtime.version",{component:"Node.js ",version:process.version}));
            <span class="missing-if-branch" title="if path not taken" >I</span>if (settings.UNSUPPORTED_VERSION) {
...
&nbsp;
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (nodeErrors.length &gt; 0) {
                    log.warn("------------------------------------------------------");
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (nodeMissing.length &gt; 0) {
...
<span class="cstat-no" title="statement not covered" >                        redNodes.cleanModuleList();</span>
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (settings.settingsFile) {
