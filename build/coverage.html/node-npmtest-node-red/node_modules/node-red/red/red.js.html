...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-node-red/node_modules/node-red/red/red.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-node-red/node_modules/node-red/red/red.js</span></h1>
    <h2>
        
        Statements: <span class="metric">78% <small>(39 / 50)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-node-red/node_modules/node-red/red/</a> &#187; red.js</div>
</div>
<div class="body">
...
function checkVersion(userSettings) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!semver.satisfies(process.version,"&gt;=4.0.0")) {
...
module.exports = {
    init: function(httpServer,userSettings) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!userSettings) {
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!userSettings.SKIP_BUILD_CHECK) {
            checkVersion(userSettings);
            checkBuild();
        }
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!userSettings.coreNodesDir) {
            userSettings.coreNodesDir = path.resolve(path.join(__dirname,"..","nodes"));
        }
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (userSettings.httpAdminRoot !== false) {
...
<span class="cstat-no" title="statement not covered" >            apiEnabled = false;</span>
    ...
    start: function() {
        return runtime.start().then(function() {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (apiEnabled) {
                return api.start();
            }
        });
    },
