...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-node-red/node_modules/node-red/red/runtime/nodes/flows/Flow.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-node-red/node_modules/node-red/red/runtime/nodes/flows/Flow.js</span></h1>
    <h2>
        
        Statements: <span class="metric">13.53% <small>(36 / 266)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">13.74% <small>(36 / 262)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-node-red/node_modules/node-red/red/runtime/nodes/flows/</a> &#187; Flow.js</div>
</div>
<div class="body">
...
function Flow(global,flow) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof flow === 'undefined') {
        flow = global;
    }
    var activeNodes = {};
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (diff &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >diff.rewired)</span> {
...
&nbsp;
    this.stop = <span class="fstat-no" title="function not covered" >function(stopList) {</span>
...
&nbsp;
    this.update = <span class="fstat-no" title="function not covered" >function(_global,_flow) {</span>
...
&nbsp;
    this.getNode = <span class="fstat-no" title="function not covered" >function(id) {</span>
...
&nbsp;
    this.handleStatus = <span class="fstat-no" title="function not covered" >function(node,statusMessage) {</span>
...
&nbsp;
    this.handleError = <span class="fstat-no" title="function not covered" >function(node,logMessage,msg) {</span>
