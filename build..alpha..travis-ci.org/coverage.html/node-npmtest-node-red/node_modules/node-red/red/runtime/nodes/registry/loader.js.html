...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-node-red/node_modules/node-red/red/runtime/nodes/registry/loader.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-node-red/node_modules/node-red/red/runtime/nodes/registry/loader.js</span></h1>
    <h2>
        
        Statements: <span class="metric">72.99% <small>(154 / 211)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">55.95% <small>(47 / 84)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">70.37% <small>(19 / 27)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">72.99% <small>(154 / 211)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric">2 branches</span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-node-red/node_modules/node-red/red/runtime/nodes/registry/</a> &#187; loader.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >        return;</span>
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (!copyList &amp;&amp; blockList) {
        for (var i in src) {
...
function createNodeApi(node) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (runtime.adminApi) {
...
<span class="cstat-no" title="statement not covered" >        red.auth = {</span>
    ...
    red["_"] = function() {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (args[0].indexOf(":") === -1) {
...
function loadNodeFiles(nodeFiles) {
    ...
    for (var module in nodeFiles) {
        ...
        <span class="skip-if-branch" title="else path not taken" >E</span>if (nodeFiles.hasOwnProperty(module)) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (nodeFiles[module].redVersion &amp;&amp;
<span class="branch-1 cbranch-no" title="branch not covered" >                !semver.satisfies(runtime.version().replace("-git",""), nodeFiles[module].redVersion))</span> {
                //TODO: log it
...
<span class="cstat-no" title="statement not covered" >                continue;</span>
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (module == "node-red" || !registry.getModuleInfo(module)) {
                var first = true;
                for (var node in nodeFiles[module].nodes) {
                    /* istanbul ignore else */
                    <span class="skip-if-branch" title="else path not taken" >E</span>if (nodeFiles[module].nodes.hasOwnProperty(node)) {
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (info) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (info.hasOwnProperty("loaded")) {
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (fileInfo.hasOwnProperty("types")) {
...
&nbsp;
                    ...
                    <span class="missing-if-branch" title="if path not taken" >I</span>if ((match = langRegExp.exec(help)) !== null) {
...
&nbsp;
                ...
                for (var i=0;i&lt;node.types.length;i++) {
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (registry.getTypeId(node.types[i])) {
...
function loadNodeSet(node) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!node.enabled) {
<span class="cstat-no" title="statement not covered" >        return when.resolve(node);</span>
    ...
    try {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof r === "function") {
&nbsp;
            var red = createNodeApi(node);
            var promise = r(red);
            <span class="missing-if-branch" title="if path not taken" >I</span>if (promise != null &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof promise.then === "function")</span> {
...
<span class="cstat-no" title="statement not covered" >                    return node;</span>
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (loadPromise == null) {
            node.enabled = true;
            node.loaded = true;
...
function loadNodeSetList(nodes) {
    ...
    nodes.forEach(function(node) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!node.err) {
...
&nbsp;
    return when.settle(promises).then(function() {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (settings.available()) {
