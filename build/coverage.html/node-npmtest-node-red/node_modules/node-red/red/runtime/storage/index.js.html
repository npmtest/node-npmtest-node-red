...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-node-red/node_modules/node-red/red/runtime/storage/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-node-red/node_modules/node-red/red/runtime/storage/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-node-red/node_modules/node-red/red/runtime/storage/</a> &#187; index.js</div>
</div>
<div class="body">
...
function moduleSelector(aSettings) {
    var toReturn;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (aSettings.storageModule) {
...
<span class="cstat-no" title="statement not covered" >                    return crypto.createHash('md5').update(JSON.stringify(config)).digest("hex");</span>
        ...
        getSettings: function() {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (settingsAvailable) {
