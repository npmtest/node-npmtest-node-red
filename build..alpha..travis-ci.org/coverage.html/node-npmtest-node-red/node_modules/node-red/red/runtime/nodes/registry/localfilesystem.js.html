...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-node-red/node_modules/node-red/red/runtime/nodes/registry/localfilesystem.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-node-red/node_modules/node-red/red/runtime/nodes/registry/localfilesystem.js</span></h1>
    <h2>
        
        Statements: <span class="metric">79.08% <small>(121 / 153)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">53.85% <small>(35 / 65)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">75% <small>(12 / 16)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">79.61% <small>(121 / 152)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric">1 branch</span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-node-red/node_modules/node-red/red/runtime/nodes/registry/</a> &#187; localfilesystem.js</div>
</div>
<div class="body">
...
function isExcluded(name) {
     <span class="missing-if-branch" title="if path not taken" >I</span>if (settings.nodesExcludes) {
...
function getLocalFile(file) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (isExcluded(path.basename(file))) {
...
function getLocalNodeFiles(dir) {
    ...
    files.forEach(function(fn) {
        ...
        if (stats.isFile()) {
            ...
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (fn === "icons") {
...
function scanDirForNodesModules(dir,moduleName) {
    ...
    try {
        ...
        for (var i=0;i&lt;files.length;i++) {
            var fn = files[i];
            <span class="missing-if-branch" title="if path not taken" >I</span>if (/^@/.test(fn)) {
<span class="cstat-no" title="statement not covered" >                results = results.concat(scanDirForNodesModules(path.join(dir,fn),moduleName));</span>
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (!isExcluded(fn) &amp;&amp; (!moduleName || <span class="branch-2 cbranch-no" title="branch not covered" >fn == moduleName)</span>) {
                    ...
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (fn == moduleName) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (settings.userDir) {
        ...
        results.forEach(<span class="fstat-no" title="function not covered" >function(r) {</span> <span class="cstat-no" title="statement not covered" >r.local = true; </span>});
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (dir) {
        ...
        while (up !== dir) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (pm != userDir) {
...
&nbsp;
    var nodes = pkg['node-red'].nodes||<span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
    var results = [];
    var iconDirs = [];
&nbsp;
    for (var n in nodes) {
        /* istanbul ignore else */
        <span class="skip-if-branch" title="else path not taken" >E</span>if (nodes.hasOwnProperty(n)) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (iconDirs.indexOf(iconDir) == -1) {
                try {
                    fs.statSync(iconDir);
...
function getNodeFiles(disableNodePathScan) {
    ...
    var nodeFiles = [];
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (settings.coreNodesDir) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (settings.nodesDir) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!disableNodePathScan) {
        ...
        moduleFiles.forEach(function(moduleFile) {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (moduleFile.package['node-red'].version) {
