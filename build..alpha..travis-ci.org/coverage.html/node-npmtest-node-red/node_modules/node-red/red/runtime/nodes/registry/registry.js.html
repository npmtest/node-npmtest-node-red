...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-node-red/node_modules/node-red/red/runtime/nodes/registry/registry.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-node-red/node_modules/node-red/red/runtime/nodes/registry/registry.js</span></h1>
    <h2>
        
        Statements: <span class="metric">45.61% <small>(135 / 296)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">38.57% <small>(54 / 140)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">51.61% <small>(16 / 31)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">45.76% <small>(135 / 295)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric">10 branches</span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-node-red/node_modules/node-red/red/runtime/nodes/registry/</a> &#187; registry.js</div>
</div>
<div class="body">
...
function filterNodeInfo(n) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (n.hasOwnProperty("module")) {
        r.module = n.module;
    }
...
&nbsp;
    for (var module in moduleConfigs) {
        ...
        <span class="skip-if-branch" title="else path not taken" >E</span>if (moduleConfigs.hasOwnProperty(module)) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (Object.keys(moduleConfigs[module].nodes).length &gt; 0) {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (!moduleList[module]) {
                    moduleList[module] = {
                        name: module,
                ...
                for(var node in nodes) {
                    /* istanbul ignore else */
                    <span class="skip-if-branch" title="else path not taken" >E</span>if (nodes.hasOwnProperty(node)) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!configs) {
<span class="cstat-no" title="statement not covered" >        return {};</span>
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (configs['node-red']) {
        return configs;
    } else {
...
function addNodeSet(id,set,version) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!set.err) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!moduleConfigs[set.module]) {
...
function getNodeInfo(typeOrId) {
    var id = typeOrId;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (nodeTypeToId.hasOwnProperty(typeOrId)) {
<span class="cstat-no" title="statement not covered" >        id = nodeTypeToId[typeOrId];</span>
    }
    /* istanbul ignore else */
    <span class="skip-if-branch" title="else path not taken" >E</span>if (id) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (module) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (config) {
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (config.hasOwnProperty("loaded")) {
...
function getModuleInfo(module) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (moduleNodes[module]) {
<span class="cstat-no" title="statement not covered" >        var nodes = moduleNodes[module];</span>
...
function inheritNode(constructor) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if(Object.getPrototypeOf(constructor.prototype) === Object.prototype) {
...
function registerNodeConstructor(nodeSet,type,constructor) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (nodeConstructors.hasOwnProperty(type)) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (nodeSetInfo) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (nodeSetInfo.types.indexOf(type) === -1) {
...
function getTypeId(type) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (nodeTypeToId.hasOwnProperty(type)) {
