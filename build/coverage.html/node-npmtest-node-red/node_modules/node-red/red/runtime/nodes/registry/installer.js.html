...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-node-red/node_modules/node-red/red/runtime/nodes/registry/installer.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-node-red/node_modules/node-red/red/runtime/nodes/registry/installer.js</span></h1>
    <h2>
        
        Statements: <span class="metric">25% <small>(28 / 112)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-node-red/node_modules/node-red/red/runtime/nodes/registry/</a> &#187; installer.js</div>
</div>
<div class="body">
...
function checkPrereq() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (settings.hasOwnProperty('editorTheme') &amp;&amp;
<span class="branch-1 cbranch-no" title="branch not covered" >        settings.editorTheme.hasOwnProperty('palette') </span>&amp;&amp;
<span class="branch-2 cbranch-no" title="branch not covered" >        settings.editorTheme.palette.hasOwnProperty('editable') </span>&amp;&amp;
<span class="branch-3 cbranch-no" title="branch not covered" >        settings.editorTheme.palette.editable === false</span>
    ) {
